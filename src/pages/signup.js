    ...
    return (
        <>
            ...
            <div className="flex flex-col items-center">
                ...
                <input type="text" placeholder="Full Name" class="border-b-2 border-red-600 w-1/3 mt-8 text-xl"/>
                <input type="text" placeholder="Email" class="border-b-2 border-red-600 w-1/3 mt-6 text-xl"/>
                <input type="text" placeholder="Password" class="border-b-2 border-red-600 w-1/3 mt-6 text-xl"/>
                <input type="text" placeholder="Confirm Password" class="border-b-2 border-red-600 w-1/3 mt-6 text-xl"/>
